...
def build_catalog(raw_models: list[dict]) -> list[dict]:
    ...
    Deliberately mirrors Codex's own `/model` picker as-is (confirmed via
    screenshot) rather than collapsing generations of the same marketing
    tier — e.g. gpt-6-luna and gpt-5.6-luna are both listed there as
    distinct, separately-selectable models, not a duplicate to dedupe."""
